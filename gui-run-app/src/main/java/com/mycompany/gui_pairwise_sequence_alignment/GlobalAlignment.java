...
public class GlobalAlignment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Global Alignment : implemented with Needleman-Wunshu algorithm.");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        if((check_seq1(jTextField1.getText())==true)&&(check_seq2(jTextField2.getText())==true)){         
           new GlobalProcess(first_sequence,second_sequence).setVisible(true);                                               
           this.setVisible(false);
